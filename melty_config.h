...
#define DEFAULT_ACCEL_MOUNT_RADIUS_CM 1         //Radius of accelerometer from center of robot
...
#define LEFT_RIGHT_HEADING_CONTROL_DIVISOR 1.7f   //How quick steering is (larger values = slower)
...
#define FORBACK_RC_CHANNEL_PIN 4                   //To Forward / Back on RC receiver (Pin 1 on Arduino Micro labelled as "TX" - https://docs.arduino.cc/hacking/hardware/PinMapping32u4)
...
#define HEADING_LED_PIN	6                         //To heading LED (pin 13 is on-board Arduino LED)

//no configuration changes are needed if only 1 motor is used!
#define MOTOR_PIN1 1                              //Pin for Motor 1 driver
#define MOTOR_PIN2 7                             //Pin for Motor 2 driver
...
#define PWM_MOTOR_ON 1650                          //Motor PWM ON duty cycle (Simonk: 140 seems barely on / 230 seems a good near-full-throttle value)
